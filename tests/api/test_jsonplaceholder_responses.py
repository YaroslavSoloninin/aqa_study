...
class TestJsonplaceholder:
    @responses.activate
    def test_get_post_mocked(self, json_placeholder_api: JsonPlaceholderAPI):
        responses.add(
            responses.GET,
    ...
    @responses.activate
    def test_get_post_mocked_404(self, json_placeholder_api: JsonPlaceholderAPI):
        responses.add(
            responses.GET,
            TestData.GET_FIRST_POST_URL,
            json=TestData.FAKE_POST.model_dump(),
    ...
    @responses.activate
    def test_get_post_mocked_500(self, json_placeholder_api: JsonPlaceholderAPI):
        responses.add(
            responses.GET,
            TestData.GET_FIRST_POST_URL,
            json=TestData.FAKE_POST.model_dump(),
