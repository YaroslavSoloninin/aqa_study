...
class TestJsonplaceholder:
    @staticmethod
    def _make_mock_response(json_data: dict, status_code: int) -> MagicMock:
    ...
    @pytest.mark.mock
    def test_get_post_mocked(self, json_placeholder_api: JsonPlaceholderAPI, mocker):
    ...
    @pytest.mark.mock
    def test_get_post_mocked_404(self, json_placeholder_api: JsonPlaceholderAPI, mocker):
        mock_response = self._make_mock_response(
    ...
    @pytest.mark.mock
    def test_get_post_mocked_500(self, json_placeholder_api: JsonPlaceholderAPI, mocker):
        mock_response = self._make_mock_response(
