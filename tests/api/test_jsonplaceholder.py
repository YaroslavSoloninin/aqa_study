...
class TestJsonplaceholder:
    def test_get_post_by_id(self, json_placeholder_api: JsonPlaceholderAPI) -> None:
    ...
    def test_get_posts_by_user_id(self, json_placeholder_api: JsonPlaceholderAPI) -> None:
        ...
        assert get_posts_response.data is not None
        for post in get_posts_response.data:
            assert post.userId == TestData.GET_POSTS_USER_ID

    def test_create_post(self, json_placeholder_api: JsonPlaceholderAPI) -> None:
        post = Post(
        ...
        assert create_post_response.data is not None
    ...
    def test_delete_post(self, json_placeholder_api: JsonPlaceholderAPI) -> None:
        delete_post_response = json_placeholder_api.delete_post(TestData.DELETE_POST_ID)
